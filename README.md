# @devtea2026/cumque-nobis-similique-unde

__@devtea2026/cumque-nobis-similique-unde__ is a javascript library that resolves references in [JSON schemas](https://json-schema.org/draft/2020-12/json-schema-core#name-introduction).
...
```bash
npm install @devtea2026/cumque-nobis-similique-unde
```
...
const { RefResolver } = require('@devtea2026/cumque-nobis-similique-unde')
